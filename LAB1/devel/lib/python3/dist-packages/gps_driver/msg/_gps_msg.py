...
class gps_msg(genpy.Message):
  _md5sum = "6a76f7b7ee5e01cb30c1da7eb8aa2fbe"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','float64','float64','float64','float64','float64','float64','int32','string']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7di().pack(_x.Latitude, _x.Longitude, _x.Altitude, _x.HDOP, _x.UTM_easting, _x.UTM_northing, _x.UTC, _x.Zone))
      _x = self.Letter
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Latitude, _x.Longitude, _x.Altitude, _x.HDOP, _x.UTM_easting, _x.UTM_northing, _x.UTC, _x.Zone,) = _get_struct_7di().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
